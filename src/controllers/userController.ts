...
const randomDate = (): Date => {
    ...
    const randomTimestamp = twelveMonthsAgo.getTime() + Math.random() * (currentDate.getTime() - twelveMonthsAgo.getTime());
...
let users: User[] = [
    { id: 1, firstName: 'Piotr', lastName: 'Nowak', registrationDate: randomDate(), status: 'Active', address: { street: "Główna 8", city: "Warszawa", zipCode: "00-300" }},
    { id: 2, firstName: 'Anna', lastName: 'Kowalska', registrationDate: randomDate(), status: 'Pending', address: { street: "Podwale 15", city: "Kraków", zipCode: "30-200" }},
    { id: 3, firstName: 'Jan', lastName: 'Nowicki', registrationDate: randomDate(), status: 'Active', address: { street: "Rynek 10", city: "Wrocław", zipCode: "50-100" }},
    { id: 4, firstName: 'Maria', lastName: 'Kowalczyk', registrationDate: randomDate(), status: 'Active', address: { street: "Słowackiego 20", city: "Poznań", zipCode: "60-500" }},
    { id: 5, firstName: 'Adam', lastName: 'Jankowski', registrationDate: randomDate(), status: 'Disabled', address: { street: "Mickiewicza 5", city: "Gdańsk", zipCode: "80-200" }},
    { id: 6, firstName: 'Ewa', lastName: 'Lis', registrationDate: randomDate(), status: 'Active', address: { street: "Piłsudskiego 12", city: "Łódź", zipCode: "90-100" }},
    { id: 7, firstName: 'Tomasz', lastName: 'Pawlak', registrationDate: randomDate(), status: 'Deleted', address: { street: "Lecha 25", city: "Katowice", zipCode: "40-500" }},
    { id: 8, firstName: 'Katarzyna', lastName: 'Czarnecka', registrationDate: randomDate(), status: 'Active', address: { street: "Chrobrego 7", city: "Szczecin", zipCode: "70-200" }},
    { id: 9, firstName: 'Marcin', lastName: 'Wójcik', registrationDate: randomDate(), status: 'Active', address: { street: "Kościuszki 18", city: "Bydgoszcz", zipCode: "85-100" }},
    { id: 10, firstName: 'Magdalena', lastName: 'Szymańska', registrationDate: randomDate(), status: 'Pending', address: { street: "Konopnickiej 3", city: "Lublin", zipCode: "20-300" }},
    { id: 11, firstName: 'Wojciech', lastName: 'Dąbrowski', registrationDate: randomDate(), status: 'Active', address: { street: "Waryńskiego 16", city: "Białystok", zipCode: "15-200" }},
    { id: 12, firstName: 'Karolina', lastName: 'Kaczmarek', registrationDate: randomDate(), status: 'Pending', address: { street: "Sienkiewicza 22", city: "Częstochowa", zipCode: "42-300" }},
    { id: 13, firstName: 'Michał', lastName: 'Grabowski', registrationDate: randomDate(), status: 'Disabled', address: { street: "Wojska Polskiego 14", city: "Radom", zipCode: "26-600" }},
    { id: 14, firstName: 'Alicja', lastName: 'Zielińska', registrationDate: randomDate(), status: 'Active', address: { street: "Piastowska 9", city: "Olsztyn", zipCode: "10-100" }},
    { id: 15, firstName: 'Krzysztof', lastName: 'Adamczyk', registrationDate: randomDate(), status: 'Active', address: { street: "Gdańska 11", city: "Toruń", zipCode: "87-100" }},
    { id: 16, firstName: 'Monika', lastName: 'Lipińska', registrationDate: randomDate(), status: 'Pending', address: { street: "Kasprzaka 5", city: "Gdynia", zipCode: "81-100" }},
    { id: 17, firstName: 'Robert', lastName: 'Sikora', registrationDate: randomDate(), status: 'Active', address: { street: "Piotrkowska 7", city: "Płock", zipCode: "09-100" }},
    { id: 18, firstName: 'Natalia', lastName: 'Jastrzębska', registrationDate: randomDate(), status: 'Active', address: { street: "Wolska 2", city: "Bielsko-Biała", zipCode: "43-300" }},
    { id: 19, firstName: 'Paweł', lastName: 'Borkowski', registrationDate: randomDate(), status: 'Disabled', address: { street: "Krakowska 13", city: "Rzeszów", zipCode: "35-200" }},
    { id: 20, firstName: 'Aleksandra', lastName: 'Walczak', registrationDate: randomDate(), status: 'Deleted', address: { street: "Piwna 6", city: "Kielce", zipCode: "25-100" }},
];  
